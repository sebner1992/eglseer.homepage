...
export class MembersComponent implements OnInit, OnChanges {
  ...
  constructor(private imageService: ImageService) {
    this.taenzer = [
      ...
      { name: 'Willinger Julia', imgUrl: 'assets/mitglieder/taenzer/julie.jpg', function: 'Tänzerin, Marketenderin', activeSince: '2016', instrument: '' },
      { name: 'Krabath Bettina', imgUrl: 'assets/mitglieder/taenzer/betti.jpg', function: 'Tänzerin, Marketenderin', activeSince: '2016', instrument: '' },
