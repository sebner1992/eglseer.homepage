...
export class MembersComponent implements OnInit, OnChanges {
  ...
  constructor(private imageService: ImageService) {
    this.taenzer = [
      ...
      { name: 'Helminger Benedikt', imgUrl: 'assets/mitglieder/taenzer/bene.jpg', function: 'Obmann-Stv., Vorplattler, Tänzer ', activeSince: '2003', instrument: 'Schlagwerk' },
      ...
      { name: 'Baal Barbara', imgUrl: 'assets/mitglieder/taenzer/babsi_b.jpg', function: 'Tänzerin', activeSince: '2012', instrument: '' },
      ...
      { name: 'Zapf Katharina', imgUrl: 'assets/mitglieder/placeholder.jpg', function: 'Tänzerin', activeSince: '2015', instrument: '' },
      ...
      { name: 'Zutz Maria', imgUrl: 'assets/mitglieder/taenzer/maria_z.jpg', function: 'Tänzerin', activeSince: '1990', instrument: '' },
      { name: 'Willinger Julia', imgUrl: 'assets/mitglieder/placeholder.jpg', function: 'Tänzerin', activeSince: '2016', instrument: '' },
      { name: 'Krabath Bettina', imgUrl: 'assets/mitglieder/placeholder.jpg', function: 'Tänzerin', activeSince: '2016', instrument: '' },
      { name: 'Hirnsperger Johannes', imgUrl: 'assets/mitglieder/placeholder.jpg', function: 'Tänzer', activeSince: '2017', instrument: '' },
      { name: 'Fagerer Simon', imgUrl: 'assets/mitglieder/placeholder.jpg', function: 'Tänzer', activeSince: '2017', instrument: '' },
      { name: 'Prähauser Katrin', imgUrl: 'assets/mitglieder/placeholder.jpg', function: 'Tänzerin', activeSince: '2017', instrument: '' },
      { name: 'Herbst Sabrina', imgUrl: 'assets/mitglieder/placeholder.jpg', function: 'Tänzerin', activeSince: '2017', instrument: '' },
      { name: 'Herbst Thomas', imgUrl: 'assets/mitglieder/placeholder.jpg', function: 'Tänzer', activeSince: '2018', instrument: '' },
      { name: 'Steindl Lisa', imgUrl: 'assets/mitglieder/placeholder.jpg', function: 'Tänzerin', activeSince: '2017', instrument: '' },
      { name: 'Schmidlechner Sarah', imgUrl: 'assets/mitglieder/placeholder.jpg', function: 'Tänzerin', activeSince: '2017', instrument: '' },
      { name: 'Herbst Christina', imgUrl: 'assets/mitglieder/placeholder.jpg', function: 'Tänzerin', activeSince: '2017', instrument: '' },
      { name: 'Fagerer Andreas', imgUrl: 'assets/mitglieder/placeholder.jpg', function: 'Tänzerin', activeSince: '2017', instrument: '' },
      { name: 'Radauer Lena', imgUrl: 'assets/mitglieder/placeholder.jpg', function: 'Tänzerin', activeSince: '2017', instrument: '' },
      { name: 'Winhart Jacqueline', imgUrl: 'assets/mitglieder/placeholder.jpg', function: 'Tänzerin', activeSince: '2018', instrument: '' },
    ];
